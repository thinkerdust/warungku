<footer id="footer">
    <div class="footer-top">
        <div class="container">
            ...
            <div class="col-lg-3 col-md-6 footer-contact">
                ...
                <p>
                Jalan Gajah Raya <br>
                Gayamsari, Semarang<br>
                Indonesia <br><br>
                <strong>Phone:</strong> (+62) 8889 7564 xxxx<br>
                <strong>Email:</strong> shop@warungku.com<br>
                </p>
            </div>
            ...
            <div class="col-lg-4 col-md-6 footer-newsletter">
                ...
                <p>Dapatkan Penawaran Menarik Dari Kami!</p>
    ...
    <div class="container d-md-flex py-4">
        ...
        <div class="mr-md-auto text-center text-md-left">
            <div class="copyright">
            &copy; Copyright 2020<strong><span> Warung Ku</span></strong>. All Rights Reserved
            </div>
        </div>
